...
class Io {
    ...
    reconnect() {
        ...
        this.reconnectTimer = setTimeout((_) => __awaiter(this, void 0, void 0, function* () {
    ...
    send(ioEvent) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (this.eventBuffer.length) {
                const p = new Promise((resolve, reject) => ws.send(JSON.stringify(this.eventBuffer.shift()), (err) => {
                    if (err) {
                        reject(err);
                    }
                    else {
