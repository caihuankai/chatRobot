...
class FileBox {
    ...
    static fromDataURL(dataUrl, name) {
        return FileBox.fromBase64(misc_1.dataUrlToBase64(dataUrl), name);
    }
    static version() {
    ...
    pipe(destination) {
        this.toStream().then(stream => stream.pipe(destination));
        return destination;
    }
    toStream() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    toFile(filePath, overwrite = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const exist = yield new Promise(resolve => fs.exists(fullFilePath, resolve));
            if (exist && !overwrite) {
