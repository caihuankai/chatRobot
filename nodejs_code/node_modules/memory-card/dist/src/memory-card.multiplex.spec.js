...
blue_tape_1.default('multiplex set() & get()', (t) => __awaiter(this, void 0, void 0, function* () {
    const KEY = 'a';
    const VAL = 'b';
...
blue_tape_1.default('multiplex clear()', (t) => __awaiter(this, void 0, void 0, function* () {
    const KEY = 'a';
    const VAL = 'b';
    const NAME = Math.random().toString().substr(2);
...
blue_tape_1.default('multiplex deeper than two layers', (t) => __awaiter(this, void 0, void 0, function* () {
    const KEY = 'a';
    const VAL = 'b';
    const NAME = Math.random().toString().substr(2);
...
blue_tape_1.default('multiplex destroy()', (t) => __awaiter(this, void 0, void 0, function* () {
    const NAME = Math.random().toString().substr(2);
    const card = new memory_card_1.MemoryCard({ name: NAME });
    yield card.load();
...
blue_tape_1.default('multiplex has()', (t) => __awaiter(this, void 0, void 0, function* () {
    const KEY = 'a';
    const VAL = 'b';
    const KEYA = 'aa';
    const VALA = 'bb';
...
blue_tape_1.default('multiplex keys()', (t) => __awaiter(this, void 0, void 0, function* () {
    var e_1, _a, e_2, _b;
    const KEY = 'a';
    const VAL = 'b';
    const KEYA = 'aa';
...
blue_tape_1.default('multiplex values()', (t) => __awaiter(this, void 0, void 0, function* () {
    var e_3, _g, e_4, _h;
    const KEY = 'key';
    const VAL = 'val';
    const KEYA = 'key-a';
...
blue_tape_1.default('multiplex entries()', (t) => __awaiter(this, void 0, void 0, function* () {
    var e_5, _o, e_6, _p;
    const KEY = 'key';
    const VAL = 'val';
    const KEYA = 'key-a';
...
blue_tape_1.default('multiplex [Symbol.asyncIterator]()', (t) => __awaiter(this, void 0, void 0, function* () {
    var e_7, _u, e_8, _v;
    const KEY = 'a';
    const VAL = 'b';
    const KEYA = 'aa';
...
blue_tape_1.default('multiplex toString()', (t) => __awaiter(this, void 0, void 0, function* () {
    const NAME = Math.random().toString().substr(2);
...
blue_tape_1.default('multiplex multiplexKey()', (t) => __awaiter(this, void 0, void 0, function* () {
...
blue_tape_1.default('multiplex isMultiplex()', (t) => __awaiter(this, void 0, void 0, function* () {
    const NAME = Math.random().toString().substr(2);
    const card = new MemoryCardTest({ name: NAME });
    yield card.load();
...
blue_tape_1.default('multiplex isMultiplexKey()', (t) => __awaiter(this, void 0, void 0, function* () {
    const NAME = Math.random().toString().substr(2);
...
blue_tape_1.default('multiplex save()', (t) => __awaiter(this, void 0, void 0, function* () {
    ...
    const stub = sandbox.stub(card, 'save').callsFake(() => { });
    yield cardA.save();
    t.equal(stub.callCount, 1, 'multiplexed memory should call parent save()');
    yield card.destroy();
    sandbox.restore();
}));
blue_tape_1.default('multiplex multiplexPath()', (t) => __awaiter(this, void 0, void 0, function* () {
