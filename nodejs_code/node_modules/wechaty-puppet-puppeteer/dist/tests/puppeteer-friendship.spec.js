...
blue_tape_1.default('PuppetPuppeteerFriendship.receive smoke testing', (t) => __awaiter(this, void 0, void 0, function* () {
    const puppet = new PuppetTest();
    // const wechaty = new WechatyTest({ puppet })
    // wechaty.initPuppetAccessory(puppet)
    /* tslint:disable:max-line-length */
    const rawMessagePayload = JSON.parse(`
  ...
  `);
    ...
    const id = 'id';
    const type = wechaty_puppet_1.FriendshipType.Receive;
    const payload = {
    ...
    // await fr.ready()
    const friendshipPayload = yield puppet.friendshipPayload(id);
    ...
    t.equal(friendshipPayload.type, wechaty_puppet_1.FriendshipType.Receive, 'should be receive type');
    sandbox.restore();
}));
blue_tape_1.default('PuppetPuppeteerFriendship.confirm smoke testing', (t) => __awaiter(this, void 0, void 0, function* () {
  ...
  `);
    ...
    // await msg.ready()
    const msgPayload = yield puppet.messagePayload(rawMessagePayload.MsgId);
    ...
    // await fr.ready()
    const friendshipPayload2 = yield puppet.friendshipPayload('xx');
    t.is(friendshipPayload2.contactId, CONTACT_ID, 'should have a Contact id');
    t.is(friendshipPayload2.type, wechaty_puppet_1.FriendshipType.Confirm, 'should be confirm type');
    sandbox.restore();
}));
//# sourceMappingURL=puppeteer-friendship.spec.js.map