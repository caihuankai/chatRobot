...
const puppet_puppeteer_1 = __importDefault(require("../src/puppet-puppeteer"));
blue_tape_1.default('Contact smoke testing', (t) => __awaiter(this, void 0, void 0, function* () {
    ...
    const puppet = new puppet_puppeteer_1.default();
    sandbox.stub(puppet, 'contactRawPayload').callsFake(mockContactPayload);
    const contactPayload = yield puppet.contactPayload(UserName);
