...
// }
blue_tape_1.default('constructor()', (t) => __awaiter(this, void 0, void 0, function* () {
    ...
    yield puppet.login(MOCK_USER_ID);
    const msgPayload = yield puppet.messagePayload(rawPayload.MsgId);
...
blue_tape_1.default('ready()', (t) => __awaiter(this, void 0, void 0, function* () {
    ...
    function mockContactRawPayload(id) {
        config_1.log.silly('TestMessage', `mocked getContact(%s)`, id);
        return new Promise(resolve => {
            ...
            switch (id) {
                ...
                case expectedToUserName:
                    ...
                    break;
                default:
                    config_1.log.error('TestMessage', `mocked getContact(%s) unknown`, id);
    ...
    function mockMessageRawPayload(id) {
    ...
    const fromContactPayload = yield puppet.contactPayload(fromId);
    const toContactPayload = yield puppet.contactPayload(toId);
