...
blue_tape_1.default('parseFriendConfirm()', (t) => __awaiter(this, void 0, void 0, function* () {
    const contentList = [
        [
    ...
    let result;
    const firer = new firer_1.Firer(mockPuppetPuppeteer);
...
blue_tape_1.default('parseRoomJoin()', (t) => __awaiter(this, void 0, void 0, function* () {
    const contentList = [
        [
...
blue_tape_1.default('parseRoomLeave()', (t) => __awaiter(this, void 0, void 0, function* () {
...
blue_tape_1.default('parseRoomTopic()', (t) => __awaiter(this, void 0, void 0, function* () {
    const contentList = [
        [
