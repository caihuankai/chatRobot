...
test('DelayQueueExector execute once', function (t) {
...
test('DelayQueueExector execute thrice', function (t) {
    return __awaiter(this, void 0, void 0, function* () {
        const spy = sinon.spy();
        const delay = new DelayExector(DELAY_PERIOD_TIME);
        delay.execute(() => spy(EXPECTED_VAL1));
...
test('DelayQueueExector return Promise', (t) => __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=delay-queue-exector.spec.js.map