...
(function (global, factory) {
     ...
     */
    var nop_1 = __importDefault(require("nop"));
    ...
    var StateSwitch = /** @class */ (function () {
        function StateSwitch(_name, logInstance) {
            ...
            this.onPromise = new Promise(function (r) {
                _this.onResolver = r;
            });
        ...
        StateSwitch.prototype.on = function (state) {
            ...
            if (state) {
                ...
                if (this.offResolver === nop_1.default) {
                    this.offPromise = new Promise(function (r) { return _this.offResolver = r; });
                }
        ...
        StateSwitch.prototype.off = function (state) {
            ...
            if (state) {
                ...
                if (this.onResolver === nop_1.default) {
                    this.onPromise = new Promise(function (r) { return _this.onResolver = r; });
                }
